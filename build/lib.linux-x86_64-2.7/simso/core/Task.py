...
class TaskInfo(object):
    ...
    @property
    def set_wcet(self, newwcet):
        """P-FRP will change Worst-Case Execution Time in milliseconds in the run time."""
        self.wcet = newwcet
...
class GenericTask(Process):
    ...
    def wcetOri(self):
        """Worst-Case Execution Time in milliseconds."""
        return self._task_info.wcetOri

    @property
    def set_wcet(self, newwcet):
        """P-FRP will change Worst-Case Execution Time in milliseconds in the run time."""
        self._task_info.set_wcet(newwcet)
    ...
    def other_tasks(self):
        """
        Other tasks exectued during the preemption.
        """
        return self._other_tasks
    ...
    def _job_killer(self, job):
        print(self.name, self._sim.now(), "_job_killer", job.end_date, job.computation_time, job.wcet)
    ...
    def create_job(self, pred=None):
        ...
        """
        print(self.sim.now(), "create job", self.name, self._job_count)
        self._job_count += 1
